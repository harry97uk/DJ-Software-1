...
Audio::Audio() : audioAnalyzer(44100, 0, -1, 60.0f, 200.0f)
{
                                           ...
                                           int numSamples)
{
    ...
    while(numSamples--)
    {
        ...
        inSampL = *outL;
        inSampR = *outR;
        float cSample = inSampR + inSampL;
        
        audioAnalyzer.process(&cSample, 2);
        audioAnalyzer.getresults(nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, &bpm, nullptr, nullptr);
